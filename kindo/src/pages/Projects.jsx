...
import { 
  ChevronLeft, ChevronRight, ExternalLink, Calendar, 
  Code, Globe, Briefcase, Play, Pause, Clock,
  Github, Figma, Database, Server, Smartphone,
  Cpu, Layout, Zap, Terminal, Palette,
  Layers, Shield, Cloud, Smartphone as PhoneIcon,
  GitBranch, Database as DbIcon, Settings, Wifi
} from 'lucide-react'
  ...
  const projects = [
    {
      ...
      period: '2023',
      description: 'GTCCU is committed to empowering our members through innovative financial solutions.',
      fullDescription: 'Developed a modern, responsive website for Ghana Teacher Co-operative Credit Union using React and Tailwind CSS. The platform showcases their decades of trusted service, featuring tailored savings plans, affordable loans, and financial growth solutions that foster security and prosperity for members.',
      image: '/images/gtccu.png',
      links: [
    ...
    },
    {
      ...
      period: '2023',
      description: 'Advancing Empowerment For Women & Girls through digital presence.',
      fullDescription: 'Built a dynamic website for Female Empowerment Initiative (FEEM) to amplify their mission of causing positive impact through women empowerment. The platform highlights their educational programs, community initiatives, and advocacy work for both young and old women in society.',
      image: '/images/feem.png',
      links: [
        { name: 'View Project', url: '#' },
        { name: 'Case Study', url: '#' }
      ],
      features: 'Event calendar, donation system, blog platform, user management',
    ...
    },
    {
      ...
      period: '2023',
      description: 'Islamic finance and investment advisory firm unlocking Africa\'s infrastructure potential.',
      fullDescription: 'Created a sophisticated website for ZongoVation Capital Ltd., showcasing their Shariah-compliant, asset-backed financing solutions. The platform connects ethical capital from GCC, Asia, and Africa to sustainable projects through Sukuk (Islamic bonds) and impact investment vehicles.',
      image: '/images/zongovation.png',
      links: [
        { name: 'Visit Site', url: '#' },
        { name: 'Demo', url: '#' }
      ],
      features: 'Interactive investment tools, multilingual support, animated charts, real-time data',
      icons: [Github, Server],
      accentColor: '#10b981'
    },
    {
      ...
      period: '2022',
      description: 'My first React project - Transforming legal research with AI.',
      fullDescription: 'Developed an AI-powered legal research assistant platform that helps legal professionals access case law, statutes, and legal precedents efficiently. This project marked my introduction to React development and modern web technologies.',
      image: '/images/legalscholar.png',
      links: [
        { name: 'Demo', url: '#' },
        { name: 'GitHub', url: '#' }
      ],
      features: 'AI chat interface, legal database integration, document analysis, search algorithms',
      icons: [Github, Database],
      accentColor: '#f59e0b'
    },
    {
      ...
      fullDescription: 'Built an educational platform that combines authentic Islamic teachings with modern educational technology. Digital Madrasah offers courses, live classes, and learning resources for students of all ages seeking traditional Islamic knowledge through digital means.',
      image: '/images/madrasah.png',
      links: [
        { name: 'Platform', url: '#' },
        { name: 'Documentation', url: '#' }
      ],
      features: 'Live classes, course management, progress tracking, payment integration, video streaming',
    ...
    },
    {
      ...
      fullDescription: 'Developed a comprehensive healthcare services website with full admin dashboard for Above Ability Health Services. The platform showcases their commitment to providing the finest care and maintaining highest standards of integrity in client service.',
      image: '/images/aboveability.png',
      links: [
        { name: 'Website', url: '#' },
        { name: 'Admin Demo', url: '#' }
      ],
      features: 'Admin dashboard, appointment system, service catalog, client portal, analytics',
      icons: [Github, Database],
      accentColor: '#06b6d4'
    },
    {
      ...
      fullDescription: 'Created a basic but professional website for Larry Group of Companies, showcasing their diverse operations across three unique sectors. This project focused on clean design, clear messaging, and establishing their brand as a dynamic enterprise rooted in quality and sustainability.',
      image: '/images/larrygroup.png',
      links: [
        { name: 'Live Site', url: '#' },
        { name: 'Design Files', url: '#' }
      ],
      features: 'Multi-page navigation, service showcase, contact forms, gallery, testimonials',
      icons: [Github, Figma],
      accentColor: '#8b5cf6'
    },
    {
      ...
      fullDescription: 'Developed a cryptocurrency trading platform that makes buying, selling, sending, and receiving crypto assets like Bitcoin, Ethereum, USDT, and Tron easy and secure. The platform offers 24/7 transactions with transparent fees and user-friendly interface.',
      image: '/images/qwenz.png',
      links: [
        { name: 'Platform', url: '#' },
        { name: 'API Docs', url: '#' }
      ],
      features: 'Real-time trading, secure transactions, crypto wallet, transaction history, charts',
      icons: [Github, Server],
      accentColor: '#10b981'
    }
  ]
  ...
  const workExperience = [
    {
      ...
      description: 'Leading digital agency empowering businesses through innovative digital solutions.',
      fullDescription: 'Working as a Frontend Web Developer at Namibra, specializing in mobile and web development. Collaborating closely with clients to transform technology from a barrier into a catalyst for growth, delivering tailored solutions that drive operational efficiency and long-term success across various digital domains including AI, blockchain, BI, and cybersecurity.',
      image: '/images/namibra.png',
      links: [
  ...
  function ReactIcon(props) {
    return (
      ...
      >
        ...
        <ellipse cx="20" cy="20" rx="12" ry="4" stroke="#61DAFB" strokeWidth="2" fill="none" />
        <ellipse cx="20" cy="20" rx="12" ry="4" stroke="#61DAFB" strokeWidth="2" fill="none" transform="rotate(60 20 20)" />
        <ellipse cx="20" cy="20" rx="12" ry="4" stroke="#61DAFB" strokeWidth="2" fill="none" transform="rotate(120 20 20)" />
      </svg>
    )
  }
    ...
    if (isAutoPlaying) {
      progressInterval.current = setInterval(() => {
        setProgress(prev => {
          ...
          return prev + (100 / 45) // 45 seconds total
        })
      }, 1000)
    } else {
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          >
            Development <span style={{ color: currentItem.accentColor || '#3b82f6' }}>Portfolio</span>
          </motion.h1>
          ...
          >
            Showcasing {activeTab === 'projects' ? 'innovative web solutions' : 'professional growth'} through hands-on experience
          </motion.p>
          ...
          >
            ...
            >
              <button
                ...
                style={{
                  backgroundColor: activeTab === 'projects' ? currentItem.accentColor || '#3b82f6' : 'transparent',
                  color: activeTab === 'projects' ? '#ffffff' : 'var(--text-color)'
                }}
              >
                <Code size={16} />
              ...
              <button
                ...
                style={{
                  backgroundColor: activeTab === 'work' ? currentItem.accentColor || '#3b82f6' : 'transparent',
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    {currentItem.icons?.map((Icon, index) => (
                      ...
                      >
                        <Icon size={20} style={{ color: currentItem.accentColor || '#3b82f6' }} />
                      </div>
                    ))}
                  </div>

                  {/* Technologies Used */}
                  <div className="flex items-center gap-2 text-sm" style={{ opacity: 0.8 }}>
                    <Code size={14} />
                  ...
                  {/* Meta Information */}
                  <div className="flex flex-wrap gap-4 text-sm" style={{ opacity: 0.8 }}>
                ...
                <div className="space-y-6">
                  <div className="relative">
                    <div 
                      ...
                      style={{ backgroundColor: currentItem.accentColor || '#3b82f6' }}
                    />
                    <div className="pl-6">
                ...
                <div className="space-y-4">
                  <h3 
                    ...
                    style={{ color: currentItem.accentColor || '#3b82f6' }}
                  >
                    {activeTab === 'projects' ? 'Key Features' : 'Role & Responsibilities'}
                  </h3>
                  <p className="text-sm leading-relaxed">
                    {activeTab === 'projects' ? currentItem.features : currentItem.role}
                  </p>
                </div>
                ...
                {currentItem.links && currentItem.links.length > 0 && (
                  <div className="space-y-4">
                    <h3 
                      ...
                      style={{ color: currentItem.accentColor || '#3b82f6' }}
                    >
                      {activeTab === 'projects' ? 'Project Links' : 'Company Links'}
                    </h3>
            ...
            <div className="space-y-6">
              ...
              <div 
                ...
                style={{
                  backgroundColor: 'var(--card-bg)',
                  borderColor: 'var(--border-color)',
                  height: 'calc(100vh - 200px)', // Full screen height on mobile
                  minHeight: '400px'
                }}
              >
                ...
                <div className="w-full h-full flex items-center justify-center relative">
                  <div 
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${currentItem.accentColor || '#3b82f6'}10 0%, ${currentItem.accentColor || '#3b82f6'}05 100%)`
                    }}
                  />
                    ...
                    {[1, 2, 3].map((ring) => (
                      <div
                        ...
                        style={{
                          ...
                          borderColor: `${currentItem.accentColor || '#3b82f6'}${10 + ring * 10}`,
                          borderWidth: '1px',
                  ...
                  <div className="relative z-10 text-center p-4 sm:p-8">
                    <Globe size={48} className="mx-auto mb-4 sm:mb-6" style={{ color: currentItem.accentColor || '#3b82f6' }} />
                    <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3">{currentItem.title}</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 text-sm sm:text-base">Interactive Preview</p>
                    <div className="flex flex-wrap gap-1 sm:gap-2 justify-center">
                      {currentItem.technologies?.split(', ').map((tech, index) => (
                        <span
                          key={index}
                          className="px-2 sm:px-3 py-1 rounded-full text-xs font-medium"
                          style={{
                            backgroundColor: `${currentItem.accentColor || '#3b82f6'}20`,
                            color: currentItem.accentColor || '#3b82f6'
                          }}
                        >
                          {tech}
                ...
                >
                  ...
                  <div className="w-px h-4 mx-2 opacity-30 hidden sm:block" style={{ backgroundColor: 'var(--text-color)' }} />
                  <Clock size={14} className="opacity-60 hidden sm:block" />
                  <span className="opacity-60 hidden sm:inline">{Math.round((100 - progress) / (100/45))}s</span>
                </div>
        ...
        >
          <h3 className="text-lg font-semibold mb-8 text-center" style={{ opacity: 0.9 }}>
          ...
          <div className="relative h-40 overflow-hidden">
            ...
            >
              {[...techIcons.reverse(), ...techIcons.reverse()].map((tech, index) => (
                <motion.div
                  key={index}
                  className="flex flex-col items-center justify-center w-20 h-20 rounded-full backdrop-blur-lg border-2 shadow-xl"
                  style={{ 
          ...
          <div className="flex justify-center items-center gap-2 mt-6">
            <div className="flex gap-1">
              {[1, 2, 3].map((dot) => (
                <div
                  key={dot}
                  className={`w-1 h-1 rounded-full ${dot === 2 ? 'opacity-100' : 'opacity-30'}`}
