...
>
  <div className="max-w-full mx-auto">
    ...
    {/* CHANGED: Using CSS Grid instead of flex for better control */}
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
      
      {/* Timeline Container - Takes 2/3 width (2 columns) */}
      ...
      {/* Sticky Image Container - Takes 1/3 width (1 column) */}
      <div className="lg:col-span-1">
        {/* Desktop - Sticky within section */}
        <div className="hidden lg:block">
          {/* CHANGED: Simplified sticky container */}
